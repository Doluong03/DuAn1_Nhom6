 ...
 */
package com.poly.IT17326.view;

import com.poly.IT17326.domainmodel.SanPham;
import com.poly.IT17326.service.Iplm.SanPhamServiceIplm;
...
public class ViewSanPham extends javax.swing.JFrame {
    ...
    private void loadData(List<SanPham> sanPhams) {
        ...
        defaultTableModel.setColumnIdentifiers(new String[]{"id", "Ma", "Ten", "Create at", "Update at", "Delete"});
        for (SanPham sv : sanPhams) {
            defaultTableModel.addRow(new Object[]{sv.getId(), sv.getMa(), sv.getTen(), sv.getCreateAt(), sv.getUpdateAt(), sv.getDeleted()});
    ...
    private void initComponents() {
        ...
        txtdete = new javax.swing.JTextField();
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(jLabel7)
                    .addComponent(txtdete, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(btnthem)
                    .addComponent(btnsua)
    ...
    private javax.swing.JTextField txtdete;
